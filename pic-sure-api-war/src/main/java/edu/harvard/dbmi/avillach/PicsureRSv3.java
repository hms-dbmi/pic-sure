...
@OpenAPIDefinition(info = @Info(title = "Pic-sure API", version = "3.0.0", description = "This is the Pic-sure API."))
@Path("/v3/")
@Produces("application/json")
@Consumes("application/json")
public class PicsureRSv3 {

    private final Logger logger = LoggerFactory.getLogger(PicsureRSv3.class);
    ...
    @Inject
    PicsureQueryV3Service queryService;
