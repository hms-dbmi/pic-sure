 ...
 */
public class PicsureQueryV3Service {
    ...
    private final Logger logger = LoggerFactory.getLogger(PicsureQueryV3Service.class);
    ...
    private QueryStatus reSubmitQuery(Query query, GeneralQueryRequest credentialsQueryRequest, Resource resource) {
        ...
        return resourceWebClient
            .reSubmitQuery("http://localhost:8080/pic-sure-api-2/PICSURE", query.getResourceResultId(), credentialsQueryRequest);
    }
    ...
    public Response queryResult(UUID queryId, QueryRequest credentialsQueryRequest, HttpHeaders headers) {
        ...
        Query query = queryRepo.getById(queryId);
        if (query == null) {
            throw new ProtocolException(ProtocolException.QUERY_NOT_FOUND + queryId);
        }
        Resource resource = query.getResource();
        if (resource == null) {
        ...
        logger.info(
            "path=/v3/query/{queryId}/result, resourceId={}, requestSource={}, queryRequest={}", queryId,
    ...
    public Response queryResultSignedUrl(UUID queryId, QueryRequest credentialsQueryRequest, HttpHeaders headers) {
        ...
        logger.info(
            "path=/v3/query/{queryId}/signed-url, resourceId={}, requestSource={}, queryRequest={}", queryId,
            Utilities.getRequestSourceFromHeader(headers), Utilities.convertQueryRequestToString(mapper, credentialsQueryRequest)
        );
    ...
    public Response querySync(QueryRequest queryRequest, HttpHeaders headers) {
        ...
        logger.info(
            "path=/v3/query/sync, resourceId={}, requestSource={}, queryRequest={}", queryRequest.getResourceUUID(), requestSource,
    ...
    public QueryStatus queryMetadata(UUID queryId, HttpHeaders headers) {
        ...
        logger.info(
            "path=/v3/query/{queryId}/metadata, requestSource={}, queryId={}", Utilities.getRequestSourceFromHeader(headers), queryId
        );
    ...
    private void verifyQueryStatusRequest(Resource resource, QueryRequest credentialsQueryRequest, UUID queryId, HttpHeaders headers)
        ...
        logger.info(
            "path=/v3/query/{queryId}/status, queryId={}, requestSource={}, queryRequest={}", queryId,
            Utilities.getRequestSourceFromHeader(headers), Utilities.convertQueryRequestToString(mapper, credentialsQueryRequest)
        );
    }
    ...
    private Resource verifyQueryRequest(QueryRequest dataQueryRequest, HttpHeaders headers) throws ProtocolException {
        ...
        logger.info(
            "path=/v3/query, requestSource={}, queryRequest={}", Utilities.getRequestSourceFromHeader(headers),
