...
public class QueryRequestTest {
    ...
    public void shouldSerializeGeneralQueryRequest() throws JsonProcessingException {
        ...
        Assertions.assertEquals(GeneralQueryRequest.class, actual.getClass());
        Assertions.assertEquals(expected.getResourceUUID(), actual.getResourceUUID());
    }
    ...
    public void shouldSerializeGICRequest() throws JsonProcessingException {
        ...
        Assertions.assertEquals(FederatedQueryRequest.class, actual.getClass());
        Assertions.assertEquals(expected.getResourceUUID(), actual.getResourceUUID());
    }
