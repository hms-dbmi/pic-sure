...
public class ResourceWebClientTest {
    ...
    public void testInfo() throws JsonProcessingException {
        ...
        wireMockRule.stubFor(any(urlEqualTo("/info")).willReturn(aResponse().withStatus(200).withBody(resourceInfo)));
        ...
        wireMockRule.stubFor(any(urlEqualTo("/info")).willReturn(aResponse().withStatus(200).withBody(incorrectResponse)));
    ...
    public void testSearch() throws JsonProcessingException {
        ...
        wireMockRule.stubFor(any(urlEqualTo("/search")).willReturn(aResponse().withStatus(200).withBody(searchResults)));
        ...
        /*
         * Map<String, String> credentials = new HashMap<>(); credentials.put(ResourceWebClient.BEARER_TOKEN_KEY, token);
         * request.setQuery(null); request.setResourceCredentials(credentials); try { cut.search(testURL, request); fail(); } catch
         * (ProtocolException e) { assertEquals(ProtocolException.MISSING_DATA, e.getContent()); }
         */
        ...
        wireMockRule.stubFor(
            any(urlEqualTo("/search")).willReturn(aResponse().withStatus(200).withBody(json.writeValueAsString(incorrectResponse)))
        );
    ...
    public void testQuery() throws JsonProcessingException {
        ...
        wireMockRule.stubFor(any(urlEqualTo("/query")).willReturn(aResponse().withStatus(200).withBody(queryResults)));
        ...
        incorrectResponse.setId(new UUID(1L, 1L));
        wireMockRule.stubFor(
            any(urlEqualTo("/query")).willReturn(aResponse().withStatus(200).withBody(json.writeValueAsString(incorrectResponse)))
        );
    ...
    public void testQueryStatus() throws JsonProcessingException {
        ...
        wireMockRule.stubFor(any(urlMatching("/query/.*/status")).willReturn(aResponse().withStatus(200).withBody(queryStatus)));
        ...
        wireMockRule.stubFor(
            any(urlMatching("/query/.*/status")).willReturn(aResponse().withStatus(200).withBody(json.writeValueAsString(incorrect)))
        );
