 ...
 */
public class GICQueryRequest implements QueryRequest {
	...
	@Override
	public GICQueryRequest setResourceCredentials(Map<String, String> resourceCredentials) {
	...
	@Override
	public GICQueryRequest setQuery(Object query) {
		this.query = query;
		return this;
	}
	...
	@Override
	public GICQueryRequest copy() {
		GICQueryRequest request = new GICQueryRequest();
