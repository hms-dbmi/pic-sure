...
@Singleton
public class AggregateDataSharingResourceRSV3 implements IResourceRS {
    ...
    public AggregateDataSharingResourceRSV3() {
        this(null);
    }

    @Inject
    public AggregateDataSharingResourceRSV3(ApplicationProperties applicationProperties) {
    ...
    private Map<String, String> processCrossCounts(String entityString) throws JsonProcessingException {
