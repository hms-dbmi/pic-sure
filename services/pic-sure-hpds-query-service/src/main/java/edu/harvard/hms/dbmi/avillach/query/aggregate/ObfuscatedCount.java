...
public final class ObfuscatedCount {
    ...
    /**
     * Half-width of the uncertainty band around {@link #count}, or null when the value is exact (authorized path). Consumers render the
     * band as [max(0, count - variance), count + variance].
     */
    ...
    public ObfuscatedCount(
        @JsonProperty("count") int count, @JsonProperty("display") String display, @JsonProperty("variance") Integer variance
    ) {
        this.count = count;
    ...
    /** Wraps a plain (non-obfuscated) integer count; display is the stringified number, variance null. */
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ObfuscatedCount that)) return false;
