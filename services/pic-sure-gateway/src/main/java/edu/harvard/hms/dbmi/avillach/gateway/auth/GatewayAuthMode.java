 ...
 * {@link edu.harvard.hms.dbmi.avillach.gateway.config.GatewaySecurityProperties}, which continues to gate the introspection filter chain
 ...
 * <li>{@link #ENFORCE}: full gateway auth behavior (introspect + mutate + enforce) on EVERY route. Resolved from mode-unset +
