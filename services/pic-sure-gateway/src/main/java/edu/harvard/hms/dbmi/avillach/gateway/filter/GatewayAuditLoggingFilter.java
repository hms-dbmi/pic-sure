...
public class GatewayAuditLoggingFilter extends AuditLoggingFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        // Additive: skip when either the interim scope says WildFly still owns this path, OR the base class's
        // own conditions (disabled client, OPTIONS, /system/status, /openapi.json, skipContains) say skip.
