 ...
 * assigns one) without re-sending the whole row. {@code status} is the {@link edu.harvard.dbmi.avillach.domain.PicSureStatus} enum NAME;
 * {@code metadata} is base64-encoded bytes.
 */
