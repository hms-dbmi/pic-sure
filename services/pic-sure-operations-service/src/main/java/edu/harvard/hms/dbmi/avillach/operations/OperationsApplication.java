...
/**
 * Entry point for pic-sure-operations-service: the sole owner of the pic-sure MySQL {@code Configuration}, {@code NamedDataset},
 * {@code Query}, and banner occurrence tables. Exposes {@code /configuration/**}, {@code /dataset/**}, {@code /banners/**}, and the
 * internal query API.
 *
