...
public class VariantListV3Processor implements HpdsV3Processor {
	...
	private static Logger log = LoggerFactory.getLogger(VariantListV3Processor.class);
	...
	@Autowired
	public VariantListV3Processor(QueryExecutor abstractProcessor, GenomicProcessor genomicProcessor, ColumnSorter columnSorter, @Value("${VCF_EXCERPT_ENABLED:false}") boolean vcfExcerptEnabled) {
