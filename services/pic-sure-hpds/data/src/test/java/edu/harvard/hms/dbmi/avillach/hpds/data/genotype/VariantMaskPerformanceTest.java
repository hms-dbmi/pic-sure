...
public class VariantMaskPerformanceTest {
    ...
    /**
     * This test shows the ideal maximum size for a sparse variant is between 5-10 items. The slight decrease in performance is generally
     * worth the drastic reduction in disks space
     */
    // @Test
    public void test() {
        ...
        VariantMaskSparseImpl sparseMask100k2 =
            new VariantMaskSparseImpl(Set.of(100, 101, 200, 300, 400, 1000, 20_000, 30_000, 50_000, 90_000));
        VariantMaskSparseImpl sparseMask1m =
            new VariantMaskSparseImpl(Set.of(100, 200, 400, 50_000, 90_000, 300_000, 420_000, 555_555, 867_530, 999_999));
        ...
        System.out
            .println(mask100k.getBitmask().bitLength() + " bitmask union completed in " + (System.currentTimeMillis() - time) + " ms");
        ...
        System.out.println(
            mask100k.getBitmask().bitLength() + " bitmask and " + sparseMask100k.patientIndexes.size() + " sparse union completed in "
        ...
        System.out.println(
            mask100k.getBitmask().bitLength() + " bitmask and " + sparseMask100k2.patientIndexes.size() + " sparse union completed in "
                + (System.currentTimeMillis() - time) + " ms"
        );
        ...
        System.out.println(
            mask1m.getBitmask().bitLength() + " bitmask and " + sparseMask100k.patientIndexes.size() + " sparse union completed in "
                + (System.currentTimeMillis() - time) + " ms"
        );
        ...
        System.out.println(
            mask1m.getBitmask().bitLength() + " bitmask and " + sparseMask1m.patientIndexes.size() + " sparse union completed in "
                + (System.currentTimeMillis() - time) + " ms"
        );
